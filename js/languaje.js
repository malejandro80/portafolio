...
const lang = {
  english: {
    ...
    phone: 'Phone',
    skills: 'Skills',
    used_use: 'Tools i have worked',
    about_message:
      "Hello, my name is Miguel and it's a pleasure to greet you, I've been in the world of programming for about 7 years. I started in university where I studied mechanical engineering, basic programming was in the curriculum, I liked it so much that I decided to continue learning on my own reading books, magazines, blogs, taking courses on various online education platforms and doing my own projects. I have worked in several renowned applications both nationally and internationally, I have worked for agencies and also independently. Not all my hobbies are based solely on programming, I am also interested in science, physics, mechanics, industrial automation, arts and music.",
  ...
  spanish: {
    ...
    phone: 'Telefono',
    skills: 'Habilidades',
    used_use: 'Herramientas con las que he trabajado.',
    about_message:
      'Hola, me llamo miguel y es un gusto saludarte, llevo aproximadamente en el mundo de la programación 7 años. Comencé en la universidad donde estudie ingeniería mecánica, programación básica estaba en el pensum de estudio. Me gusto tanto que decidí seguir aprendiendo por mi cuenta leyendo libros, revistas, blogs, haciendo cursos en diversas plataformas de educación online y realizando proyectos propios. He trabajado en varias aplicaciones de renombre tanto a nivel nacional como internacional, he trabajado para agencias y también de manera independiente. No todos mis gustos se basan solo en programar, también tengo interés en la ciencia, la física, mecánica, automatización industrial, artes y música.',
    ...
    find_me: 'Contáctame',
    find_me_msj:
      'Sígueme en mis redes sociales o escríbeme para saber más, con gusto te respondere.',
    cite:
